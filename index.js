...
import session from 'express-session'; //fazendo com que HTTP seja visto como um protocolo stateful 
...
//Para controlar estados e informações exclusivas para um determinado usuário, 
//entre tantos outros que poderão acessar a aplicação, é preciso estabelecer
//uma sessão para cada um dos usuários.
//Para fazer isso é necessário instalar o módulo session do express (npm install express-session)
app.use(session({
...
app.use(cookieParser()); //Mais um middleware para permitir que a aplicação manipule cookies

//função para verificar se o usuário está autenticado (middleware)
...
//permitir que os usuários acessem o conteúdo da pasta 'publico'
app.use(express.static(path.join(process.cwd(), 'publico')));

//permitir que os usuários tenham acesso ao conteúdo da pasta 'protegido'
//verificando antes, se o usuário está autenticado.
